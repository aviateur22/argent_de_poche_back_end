...
-- CREATE ROLE local_poche WITH LOGIN PASSWORD 'xxxx';
...
-- Le role: local_poche est créé en tant que user applicatif avec des droits limités
...
-- Attribution des droits pour le user applicatif poche_moe_app
GRANT CONNECT ON DATABASE db_argent_de_poche_moe TO poche_moe_app;
GRANT usage ON SCHEMA sc_argent_de_poche TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.parent TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_image TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.family_account TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.family TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_movement TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.parent_family_account TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.role TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.role_parent TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.jwt TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.login TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.delay_login TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_calendar TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_money TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.movement_action_code TO poche_moe_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_movement_code TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.parent_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_image_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.family_account_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.family_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_movement_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.parent_family_account_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.role_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.role_parent_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.jwt_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.login_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.delay_login_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_calendar_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_money_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.movement_action_code_id_seq TO poche_moe_app;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_movement_code_id_seq TO poche_moe_app;
