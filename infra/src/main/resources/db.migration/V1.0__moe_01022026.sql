...
$do$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'poche_moe') THEN
        CREATE ROLE poche_moe WITH LOGIN PASSWORD 'poche';
        GRANT CONNECT ON DATABASE argent_de_poche TO poche_moe;
    END IF;
END
$do$;
...
ALTER SCHEMA sc_argent_de_poche OWNER TO poche_moe;
...
ALTER TABLE IF EXISTS sc_argent_de_poche.parent OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child_image OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.family_account OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.family OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child_account OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child_account_movement OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.parent_family_account OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.role OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.role_parent OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.jwt OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.login OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.delay_login OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child_account_calendar OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child_account_money OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.movement_action_code OWNER TO poche_moe;
ALTER TABLE IF EXISTS sc_argent_de_poche.child_account_movement_code OWNER TO poche_moe;

GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.parent TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_image TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.family_account TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.family TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_movement TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.parent_family_account TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.role TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.role_parent TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.jwt TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.login TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.delay_login TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_calendar TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_money TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.movement_action_code TO poche_moe;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_movement_code TO poche_moe;
...
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.parent_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_image_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.family_account_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.family_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_account_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_account_movement_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.parent_family_account_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.role_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.role_parent_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.jwt_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.login_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.delay_login_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_account_calendar_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_account_money_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.child_account_movement_code_id_seq OWNER TO poche_moe;
ALTER SEQUENCE IF EXISTS sc_argent_de_poche.movement_action_code_id_seq OWNER TO poche_moe;
