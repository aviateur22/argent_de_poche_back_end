...
-- Attribution des droits pour le user applicatif local_poche
GRANT CONNECT ON DATABASE db_argent_de_poche TO local_poche;
GRANT usage ON SCHEMA sc_argent_de_poche TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.parent TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_image TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.family_account TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.family TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_movement TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.parent_family_account TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.role TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.role_parent TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.jwt TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.login TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.delay_login TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_calendar TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_money TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.movement_action_code TO local_poche;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE sc_argent_de_poche.child_account_movement_code TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.parent_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_image_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.family_account_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.family_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_movement_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.parent_family_account_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.role_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.role_parent_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.jwt_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.login_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.delay_login_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_calendar_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_money_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.movement_action_code_id_seq TO local_poche;
GRANT USAGE, SELECT ON SEQUENCE sc_argent_de_poche.child_account_movement_code_id_seq TO local_poche;
